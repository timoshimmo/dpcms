...
if(isset($_POST['btn_filter_btw_dates'])) {
	 
	$filter_start_date = mysqli_real_escape_string($con,$_POST['filter_start_date']);
    $filter_end_date = mysqli_real_escape_string($con,$_POST['filter_end_date']);
    $cnt = 1;
