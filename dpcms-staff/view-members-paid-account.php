		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Manage Paid Accounts for <u><?php echo ucwords($fetch_users_info['fullname']); ?></u></h1>
					</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									...
									<h6 class="card-subtitle text-muted">These are the lists of accounts that have been cleared for settlement and have also been paid for empowerment. These types of accounts are removed from the user's dashboard after settlements have been fully settled.</h6>
								</div>
								<div class="card-body">
...
<?php
$cnt = 1;
$query_accounts = get_users_paid_settlements_account($user_id);
