		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Manage Thrift Transactions</h1>
						<a href="admin-filter-export-thrift-txn.php"><button style="float:center;" class="btn btn-primary" onclick="return confirm('Are you sure you want to export the data as CSV? \n\n OK to continue');">Export as CSV</button></a>
					</div>

					<div class="card">
						<div class="card-header pb-0">

							<h5 class="card-title mb-0">Lists of thrift transactions for general members.</h5>
						</div>
						<div class="card-body">
...
<?php
$cnt = 1;
$querylogin_history = mysqli_query($con,"SELECT * FROM thrift_transaction_details JOIN user_account ON user_account.user_account_id = thrift_transaction_details.user_account_id ORDER by thrift_transaction_details.txn_id DESC");
