		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Lists of Registration Payment Proofs</h1>
					</div>

					<div class="card">
						<div class="card-header pb-0">

							<h5 class="card-title mb-0">The data tables will be showing 500 lists of (<b style="color: #CE0016;">Confirmed & Pending</b>) uploaded payment proof.</h5>
						</div>
						<div class="card-body">
		...
		while ($fetch_all_users_proof_tnx = mysqli_fetch_array($query_all_users_proof_tnx)) {
			...
			<td>
				...
				if ($payment_type == "registration") {
					include 'includes/table-actions/payment-proof-actions.php';
				}
				?>
			</td>
			</tr>
