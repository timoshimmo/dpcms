<nav class="navbar navbar-expand navbar-light navbar-bg">
				...
				<form class="d-none d-sm-inline-block" action="manage-active-members" method="GET">
					<div class="input-group input-group-navbar">
						<input type="text" class="form-control" placeholder="Search with Phone Number" aria-label="Search" name="search_with_number">
				...
				<ul class="navbar-nav d-none d-lg-flex">
					<li class="nav-item px-2 dropdown" style="display: none;">
					...
					<ul class="navbar-nav navbar-align">
						...
						<li class="nav-item dropdown">
							<a class="nav-flag dropdown-toggle" href="#" id="languageDropdown" data-bs-toggle="dropdown">
								<img src="img/tribe-logo/nigeria-flag-map.jpg" alt="Nigeria" />
							</a>
							<div class="dropdown-menu dropdown-menu-end" aria-labelledby="languageDropdown">
								<a class="dropdown-item" href="#">
									<img src="img/tribe-logo/nigeria-flag-map.jpg" alt="English" width="20" class="align-middle me-1" />
									<span class="align-middle">English</span>
								</a>
								<a class="dropdown-item" href="#">
									<img src="img/tribe-logo/igbologo.png" alt="Igbo" width="20" class="align-middle me-1" />
									<span class="align-middle">Igbo</span>
								</a>
								<a class="dropdown-item" href="#">
									<img src="img/tribe-logo/yorubalogo.png" alt="Yoruba" width="20" class="align-middle me-1" />
									<span class="align-middle">Yoruba</span>
								</a>
								<a class="dropdown-item" href="#">
									<img src="img/tribe-logo/hausalogo.png" alt="Hausa" width="20" class="align-middle me-1" />
						...
						<li class="nav-item dropdown">
							<a class="nav-icon pe-md-0 dropdown-toggle" href="#" data-bs-toggle="dropdown">
								<img src="img/photos/profile-icon-png-909.png" class="avatar img-fluid rounded" alt="Charles Hall" />
							</a>
