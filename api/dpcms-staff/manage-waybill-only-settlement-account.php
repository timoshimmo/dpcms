		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Manage Waybill Settlements Account</h1>
					</div>

					<div class="card">
						<div class="card-header pb-0">

							<h5 class="card-title mb-0">Lists of Pending Waybill clearance accounts in descending order (Latest at the top).</h5>
						</div>
						<div class="card-body">
...
while($fetch_waybill = mysqli_fetch_array($query_waybill_incentives)){
	...
	/////////now that we group withdrawal request together, we need to get total number of settlement account that never been paid , still pending at the moment
				$query_pending_settlement_account = admin_query_all_pending_withdrawalable_acct_by_userid($user_id);
...
?>
										...
										<td><a href="view-more-pending-waybill-info?thrift_txn_id=<?php echo base64_encode($thrift_txn_id)?>&waybill-user=<?php echo base64_encode($fullname)?>"><button class="btn btn-primary">View More Info</button></a>
