...
<?php
$qty= 0;
$query_def = clear_aug31st_defaults_without_charges($session_logged_in_user_id);
		...
		if ($no_of_defaulted <=0) {
			...
			if ($payment_with_charges > $balance) {
				...
				////update the debts_log to update the status updated.
					@mysqli_query($con,"UPDATE debts_log SET status_updated = 'yes' WHERE user_account_id = '$user_account_id' AND user_id = '$session_logged_in_user_id'") or die(mysqli_error($con));
...
<div class="main-container">
	...
	<div class="main-content-body">
		...
		<h3 class="text-md-bold mb-2">Pay for Defaults cleared for Aug 31st Contribution</h3>
